    ...
    return (  
        <div className='container'>
            <div className='row p-5 mt-5 border-bottom text-center'>
                <h1>Pricing</h1>
                <h3 className='text-muted fs-4 mt-3'>Free equity investments and flat ₹20 traday and F&O trades</h3>
            </div>
            <div className='row p-5 mt-5 text-center'>
                ...
                <div className='col-4 p-4'>
                    <img src='media/images/intradayTrades.svg' alt='intradyTrades' />
