    ...
    <div className="container border-top mt-5" >
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <a href="abc" style={{ textDecoration: "none" }}>
            About
          </a>{" "}
          <br />
          <a href="abc" style={{ textDecoration: "none" }}>
      ...
      <div className=" text-muted p-5 " style={{fontSize:"0.65rem", marginRight:"1rem" }}>
      <p>
      ...
      <p>
        ...
        MF / bonds in the consolidated account statement issued by NSDL/CDSL
         every month.
      </p>
      <p>
